...
import { Mountain, Instagram, Facebook, Youtube, Mail, Phone, MessageCircle } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <Link href="/" className="flex items-center gap-2 mb-4">
              <Mountain className="w-8 h-8 text-primary-light" />
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href={SITE_CONFIG.social.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <Facebook className="w-5 h-5 hover:text-secondary transition-colors" />
              </a>
              <a href={SITE_CONFIG.social.youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                <Youtube className="w-5 h-5 hover:text-secondary transition-colors" />
              </a>
              <a href={`https://wa.me/${SITE_CONFIG.whatsapp}`} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href={`tel:${SITE_CONFIG.phone}`} className="hover:text-secondary">{SITE_CONFIG.phone}</a>
              </li>
            </ul>
          </div>
        </div>
